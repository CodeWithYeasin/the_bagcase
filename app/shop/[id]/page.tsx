...
export default function ProductDetailPage() {
  ...
  return (
    <section
      className="mx-auto mt-24 grid w-full max-w-7xl gap-8 px-4 py-10 md:px-8 lg:grid-cols-2"
      data-theme="light"
    >
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-3 gap-3">
          {product.images.map((image, index) => (
            <button key={`${image}-${index}`} className="relative h-28 overflow-hidden rounded-xl border border-gold/20">
      ...
      <div>
        ...
        <div className="mt-7 flex flex-wrap gap-3">
          <button
            className="rounded-full border border-gold bg-navy px-7 py-3 font-medium text-cream transition hover:bg-gold hover:text-navy disabled:cursor-not-allowed disabled:opacity-60"
